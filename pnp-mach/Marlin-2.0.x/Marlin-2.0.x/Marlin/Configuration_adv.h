...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 8000, 8000, 4*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
 ...
 * Override the default value based on the driver type set in Configuration.h.
 */
#define MINIMUM_STEPPER_PULSE 15
 ...
 * Override the default value based on the driver type set in Configuration.h.
 */
#define MAXIMUM_STEPPER_RATE 30000
